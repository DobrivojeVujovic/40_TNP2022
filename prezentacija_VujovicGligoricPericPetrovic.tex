...
\begin{frame}\frametitle{Načini prenosa}
	\begin{table}[]
		...
		\hline
		 & \begin{tabular}[c]{@{}c@{}}Induktivno\\ povezivanje\end{tabular} & \begin{tabular}[c]{@{}c@{}}Rezonantno\\ induktivno\\ povezivanje\end{tabular} & \begin{tabular}[c]{@{}c@{}}Mikrotalasni\\ prenos\end{tabular} & \begin{tabular}[c]{@{}c@{}}Laserski\\ prenos\end{tabular} \\ \hline
		Prijemna snaga & nekoliko W & nekoliko stotina W & desetine kW & do MW \\ \hline
		Moguća udaljenost & nekoliko cm & par m & do desetine km & do desetine km \\ \hline
		Frekvencija rada & nekoliko kHz & desetine kHz & nekoliko MHz & \begin{tabular}[c]{@{}c@{}}od 300GHz\\ do 1 THz\end{tabular} \\ \hline
