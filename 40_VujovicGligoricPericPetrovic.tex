...
Guljelmo Markoni je 1897. godine uspešno poslao Morzeovu azbuku na rastojanje od 6 km.
...
U međuvremenu Nikola Tesla počinje ozbiljno proučavati ideju bežičnog prenosa električne energije. Njegova zamisao je bila da bežičnim putem svetu obezbedi besplatnu elekričnu energiju. Godine 1893. osvetljava sijalicu bežičnim putem, a nedugo zatim započinje gradnju Vardenklifskog tornja
...
Godine 2008. Intel je pokazao da se može bežično poslati energija da bi se upalila sijalica sa efikasnošću prenosa 75 uspešnih pokušaja na prema 100 pokušaja.
...
Iako je Tesla demonstrirao bežični prenos energije osvetljavajući sijalice postavljene ispred zgrade u kojoj je postavio svoj eksperimentalni kalem \cite{teslinClanak}, nije naučno dokazao svoje teorije. Verovao je da je pronašao način za slanje talasa kroz Zemljinu koru koji bi, prema njegovoj teoriji, delovao na bilo kojoj udaljenosti \cite{teorija}.


\section{Načini prenosa energije}

Za prenos električne energije koriste se tehnologije za prenos na blizinu i na velike razdaljine odnosno near-field (neradijativna) i far-field (radijativna)\ref{fig:tabela1}.

\begin{table}[]
    \caption{Poređenje metoda za bežični prenos energije}
    \centering
    \begin{tabular}{|c|c|c|c|c|}
    \hline
     & \cellcolor[HTML]{C0C0C0}\textbf{\begin{tabular}[c]{@{}c@{}}Induktivno\\ povezivanje\end{tabular}} & \cellcolor[HTML]{C0C0C0}\textbf{\begin{tabular}[c]{@{}c@{}}Rezonantno\\ induktivno\\ povezivanje\end{tabular}} & \cellcolor[HTML]{C0C0C0}{\color[HTML]{000000} \textbf{\begin{tabular}[c]{@{}c@{}}Mikrotalasni\\ prenos\end{tabular}}} & \cellcolor[HTML]{C0C0C0}\textbf{\begin{tabular}[c]{@{}c@{}}Laserski\\ prenos\end{tabular}} \\ \hline
    \cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}c@{}}Prijemna \\ snaga\end{tabular} & nekoliko w & \begin{tabular}[c]{@{}c@{}}nekoliko\\ stotina W\end{tabular} & desetine kW & do MW \\ \hline
    \cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}c@{}}Moguća\\ udaljenost\end{tabular} & nekoliko cm & par m & \begin{tabular}[c]{@{}c@{}}do desetine\\ km\end{tabular} & \begin{tabular}[c]{@{}c@{}}do desetine\\ km\end{tabular} \\ \hline
    \cellcolor[HTML]{C0C0C0}\begin{tabular}[c]{@{}c@{}}Frekvencija\\ talasa\end{tabular} & nekoliko kHz & desetine kHz & nekoliko MHz & \begin{tabular}[c]{@{}c@{}}od 300GHz\\ do 1 THz\end{tabular} \\ \hline
    \cellcolor[HTML]{C0C0C0}Efikasnost & Vrlo visoka & visoka & srednja & srednja \\ \hline
    \end{tabular}
    \label{fig:tabela1}
    \end{table}
...
\bibliography{40_VujovicGligoricPericPetrovic.bib}
